...
Решение 2026-09-08: Zapara — неофициальное приложение только для БГТУ «Военмех», без подразумеваемого одобрения приложения или его ролей университетом. Цель — только русский язык во всём нативном UI Windows/Android и админке; существующий английский UI Windows этим решением ещё не удалён.
