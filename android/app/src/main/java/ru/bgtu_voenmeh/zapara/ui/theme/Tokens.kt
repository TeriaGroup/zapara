...
val DarkColors = ZaparaColors(
    ...
    chip = Color(0xFF222222), line = Color(0xFF262626), lineStrong = Color(0xFFA0A0A0),
    text1 = Color(0xFFF2F2F2), text2 = Color(0xFFA0A0A0), text3 = Color(0xFFA0A0A0),
...
val LightColors = ZaparaColors(
    ...
    chip = Color(0xFFEBEBEB), line = Color(0xFFE5E5E5), lineStrong = Color(0xFF595959),
    text1 = Color(0xFF111111), text2 = Color(0xFF595959), text3 = Color(0xFF595959),
