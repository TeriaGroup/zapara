...
class MigrationTest {
    ...
    @Test fun preserves_all_v3_rows() {
        ...
        db.close()
        val migrated = helper.runMigrationsAndValidate("theme-migration-test", 6, true, MIGRATION_3_4, MIGRATION_4_5, MIGRATION_5_6)
        ...
        migrated.query("SELECT theme, animations, useUniversityXml, mapsAlpha FROM settings").use {
