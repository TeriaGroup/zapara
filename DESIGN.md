...
Windows остаётся на своих рецептах из таблиц ниже, пока его отдельно не сводят к тому же набору.
...
Эта таблица — запись Windows. Сайт и админка с 2026-09-22 берут раздел «Единый стиль» выше.
