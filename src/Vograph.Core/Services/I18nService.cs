...
public class I18nService
{
    ...
    private readonly Dictionary<string, string> _dict = new(StringComparer.OrdinalIgnoreCase)
    {
            ...
            ["accountAcceptRequired"] = "Примите пользовательское соглашение и политику обработки персональных данных.",
            ...
            ["accountDeleteConfirm"] = "Удалить аккаунт на этом сервере? Локальные данные устройства сохранятся отдельно; полное удаление на сервере не обещается.",
            ...
            ["groupDisclaimer"] = "Роли старосты и куратора действуют только внутри «Расписание военмех» и не подтверждены университетом.",
            ...
            ["groupSaveMedia"] = "Скачать",
            ["groupSavedMedia"] = "Файл сохранён.",
            ["groupMediaFailed"] = "Не удалось скачать файл. Повторите попытку.",
            ...
            ["routeStairDown"] = "Спуститесь на {0} этаж",
            ["routeStairUp"] = "Поднимитесь на {0} этаж",
            ["routeWalk"] = "Пройдите по коридору ({0} этаж)",
            ["routeEnter"] = "Войдите в {0}",
            ["routeLink"] = "Перейдите в корпус {0}, {1} этаж",
            ["routeUnmarked"] = "маршрут ещё не размечен",
